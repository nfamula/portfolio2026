...
export default function FullPortfolioPage() {
  return (
    <main className="p-10 bg-violet-100 min-h-[calc(100vh-9rem)]">
      <h1 className="text-4xl font-bold text-slate-900 mb-8 font-sans">Web projects</h1>
      {/* todo: certifcations, skills, interests, about me */}
      {/* todo: blog: pull in from substack, pull in youtube videos */}
      <p className="text-slate-700 text-lg mb-6">
        Here are some examples of published projects from my web development career. I am always
        eager to take on new challenges and learn new technologies. If you are interested in
        learning more about my work or discussing potential opportunities, please don&apos;t
        hesitate to{" "}
