  ...
  return (
    <main className="text-slate-900">
      ...
      <section className="bg-violet-100 p-6 md:p-12">
        <div>
          <p className="font-[family-name:var(--font-accent)] italic text-2xl text-slate-800 leading-snug mb-8 border-l-4 border-slate-800 pl-6">
          ...
          <p className="font-[family-name:var(--font-body)] text-lg leading-relaxed mb-6">
          ...
          <p className="font-[family-name:var(--font-body)] text-lg leading-relaxed mb-8">
      ...
      <section className="md:h-120 w-full md:bg-[url('/images/TechTank-panel.png')] sm:bg-white md:bg-cover md:bg-center md:p-10 md:filter md:grayscale md:my-0">
        <div className="md:bg-linear-to-t md:from-black/60 md:to-transparent m-8 md:m-0">
          <h2 className="font-[family-name:var(--font-accent)] italic text-3xl text-center md:text-white sm:text-black md:text-shadow-lg">
