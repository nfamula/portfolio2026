...
export default function HomePage() {
  return (
    <main className="bg-violet-100 text-slate-900 p-12 rounded-lg flex flex-col items-center gap-8 min-h-[calc(100vh-9rem)]">
      <h1 className="text-5xl font-sans text-slate-900 text-center">Natalie Famula</h1>
      <p className="text-slate-900 text-lg font-serif max-w-xl justify-center text-center">
        I build websites and tools that help teams work smarter and projects succeed, with 10 years
        of experience across various industries. I&apos;m open to new opportunities and
        collaborations, so feel free to reach out to connect or learn more about my work.
      </p>
