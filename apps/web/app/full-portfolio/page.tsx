  ...
  return (
    <main className="p-10 bg-violet-100 min-h-[calc(100vh-9rem)]">
      ...
      <p className="text-slate-700 text-lg mb-6">
        Here are examples of published projects from my professional web development experience, and a demonstration of my coding skills. 
        I have experience across a variety of industries, including education, finance, and e-commerce, and I am always eager to take on new challenges and learn new technologies. If you are interested in learning more about my work or discussing potential opportunities, please don&apos;t hesitate to <a href="/contact" className="text-violet-700 hover:underline">reach out</a>.
      </p>
